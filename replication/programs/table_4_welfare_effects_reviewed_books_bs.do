...
*********************************************************
** BS standard errors for welfare calculation (reviewed books only)
********************************************************* 	
...
set obs 1
gen x=.
save  tempfiles/welfare_effects_reviewed_books_bs.dta, replace 
...
quietly {
	...
	** keep totals & save 
	...
	append using tempfiles/welfare_effects_reviewed_books_bs.dta 		
	save tempfiles/welfare_effects_reviewed_books_bs.dta, replace 
...
use tempfiles/welfare_effects_reviewed_books_bs.dta, clear 
	drop if CS==.
...
log using replication_logs/table_4_reviewed_books_bs_log.txt, replace text 
	
* CS result for professionally reviewed books (standard deviations)
fsum *_sd
