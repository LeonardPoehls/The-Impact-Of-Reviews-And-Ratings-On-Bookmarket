...
collapsed_data <- aggregate(cbind(summary_data_Sim$max_DNYT, summary_data_Sim$max_DOTH, summary_data_Sim$mean_drecommended, summary_data_Sim$sum_q, summary_data_Sim$sum_q1), by = list(summary_data_Sim$asin), FUN = mean)
...
summary_data2 <- data.frame(price_elas_mean, star_elas_25, star_elas_50, star_elas_75, star_elas_mean, nyt_1_5_not_rec, nyt_6_10_not_rec, nyt_11_20_not_rec, nyt_1_5_rec, nyt_6_10_rec, nyt_11_20_rec, oth_1_10, oth_11_20, other_only, nyt_not_rec_only, nyt_rec_only, both_not_rec, both_rec, overall, nytoverall)
